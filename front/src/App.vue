    ...
    <header>
      ...
      <div class="header-menu-wrap">
        ...
        <div class="info-tools-wrap">
          <PhoneNumbers class="phone" msg="(093)111-22-33, (067)123-45-67" />
          <SearchInput />
...
@media (max-width: 650px) {
  ...
  .main-content-wrap .goods-page-wrap {
    flex-wrap: wrap;
    gap: 5rem;
  }
  .main-content-wrap .item-cart {
    min-width: 17rem;
  }
